...
(function (global) {
  ...
  const STRINGS = {
    en: {
      ...
      hubLead:
        "The page stays quiet. Soft auto-gain lifts quiet rooms and headphone bleed. Tracks come from density clustering — lane count follows the sound. No melody? We still draw the noise. We never fake a tune.",
      ...
      tutLead:
        "This page never plays a song. One tap starts the mic. Soft auto-gain pulls up quiet rooms and headphone bleed. Tracks appear from density clustering — lane count follows the sound, not a fixed number.",
      btnMic: "Listen",
      btnTab: "Share tab audio",
      btnStop: "Stop",
      tourNext: "Next idea",
      crumbEli5: "ELI5",
      labelNote: "Closest piano name",
      labelHz: "Wiggles per second",
      peaksHeading: "Spectrum · clustered sources",
      meterLabel: "Input",
      meterHint: "Works with quiet rooms and headphone leak — no need to blast the speaker.",
      hudLive: "live",
      hudOff: "off",
      gateTitle: "One tap. Your audio, not ours.",
      gateBody:
        "Listen uses the microphone — audio only. Soft auto-gain means you do not need to blast headphones. Tracks appear from density clustering. This page never plays sound back.",
      footerHint:
        "Audio only. Mic is the default. On a computer you can share tab audio (any video track is discarded). Now Playing reaches this page only through the speaker or headphone leak into the mic — websites cannot read Apple’s Now Playing list.",
      statusMicOn: "Microphone — soft auto-gain on. Analysis only; nothing is played back.",
      statusTabOn: "Tab audio only (video discarded). This page stays silent.",
      ...
      quietIdle: "Tap Listen. Soft gain will lift whatever the mic can hear — room, speaker, or headphone bleed.",
      quietPitch:
    ...
    fr: {
      ...
      hubLead:
        "La page reste silencieuse. Un gain automatique relève les pièces calmes et la fuite des écouteurs. Les pistes viennent d’un clustering par densité — le nombre suit le son. Pas d’air ? On dessine quand même le bruit. On n’invente jamais de mélodie.",
      ...
      tutLead:
        "Cette page ne joue jamais de chanson. Un appui démarre le micro. Le gain automatique relève les pièces calmes et la fuite des écouteurs. Les pistes viennent d’un clustering par densité — le nombre suit le son, pas un plafond fixe.",
      btnMic: "Écouter",
      btnTab: "Partager l’audio d’un onglet",
      btnStop: "Arrêter",
      tourNext: "Idée suivante",
      crumbEli5: "Très simple",
      labelNote: "Nom de touche le plus proche",
      labelHz: "Tremblements par seconde",
      peaksHeading: "Spectre · sources regroupées",
      meterLabel: "Entrée",
      meterHint: "Marche en pièce calme et avec la fuite des écouteurs — pas besoin de pousser le volume.",
      hudLive: "direct",
      hudOff: "arrêt",
      gateTitle: "Un appui. Ton audio, pas le nôtre.",
      gateBody:
        "Écouter utilise le micro — audio seulement. Le gain automatique évite de pousser les écouteurs. Les pistes viennent d’un clustering par densité. Cette page ne rejoue jamais le son.",
      footerHint:
        "Audio seulement. Le micro est le défaut. Sur ordinateur tu peux partager l’audio d’un onglet (toute piste vidéo est écartée). En cours de lecture n’arrive ici que par le haut-parleur ou la fuite d’écouteurs dans le micro — un site ne peut pas lire la liste Apple En cours de lecture.",
      statusMicOn: "Micro — gain automatique. Analyse seulement ; rien n’est rejoué.",
      statusTabOn: "Audio d’onglet seulement (vidéo écartée). Cette page reste silencieuse.",
      ...
      errNoTabShare: "Ce navigateur ne peut pas partager l’audio d’un onglet. Sur un téléphone, utilise « Écouter ».",
      ...
      quietIdle: "Appuie sur Écouter. Le gain relève ce que le micro entend — pièce, haut-parleur ou fuite d’écouteurs.",
      quietPitch:
