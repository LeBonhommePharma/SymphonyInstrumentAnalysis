...
(function (global) {
  ...
  const STRINGS = {
    en: {
      ...
      tutLead:
        "This page never plays a song. One tap asks for the microphone. If nothing is around, live listen moves to what this computer is playing.",
      btnMic: "Listen",
      btnTab: "This computer is playing",
      btnStop: "Stop",
      tourNext: "Next idea",
      crumbEli5: "ELI5",
    ...
    fr: {
      ...
      tutLead:
        "Cette page ne joue jamais de chanson. Un appui demande le micro. S’il n’y a rien autour, l’écoute en direct passe à ce que cet ordinateur joue.",
      btnMic: "Écouter",
      btnTab: "Cet ordinateur joue",
      btnStop: "Arrêter",
